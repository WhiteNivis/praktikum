# [Разработка предсказательной модели оттока клиентов банка](https://github.com/WhiteNivis/praktikum/tree/main/05-Прогнозирование%20оттока%20клиентов%20Банка)
